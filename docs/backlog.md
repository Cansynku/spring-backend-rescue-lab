...
Order browsing increment: [bounded pagination](order-pagination.md), preserving the legacy array endpoint. Authentication and reconciliation remain separate work.
